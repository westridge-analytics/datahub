...
PROMOTED_FIELDS = {
    ...
    "secrdmrtgsend", "unsecurednotesend", "deferedrevnuend",
    "invstmntsprgmend",
...
def extract_990_fields(row: dict) -> dict:
    ...
    return {
        ...
        "deferred_revenue":            parse_int(row.get("deferedrevnuend")),
...
def _ez_record(ein, tax_period, fiscal_year, row, source_file, filing_method=None) -> dict:
    ...
    return {
        ...
        "secured_mortgages": None, "unsecured_notes": None, "deferred_revenue": None,
...
FILING_COLS = [
    ...
    "secured_mortgages", "unsecured_notes", "deferred_revenue",
